...
@section('page-content')
    <div class="p-4 bg-white border-radius-xl">
        <form action="{{route('transactions.externalStore')}}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="date" id="datepicker" placeholder="2023-04-26" required>
            </div>
            <div class="form-group">
                <label for="desc" class="form-control-label">Description<span class="text-danger">*</span></label>
                <input class="form-control" type="text" name="desc" id="desc" required placeholder="Transaction description">
            </div>
            <div class="form-group">
                ...
                <select id="amountType_select" class="form-select" name="amountType" placeholder="Select your amount type">
                    ...
                    @foreach($amtTypes as $amtType)
                        <option value="{{$amtType}}">{{$amtType}}</option>
                    @endforeach
                </select>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="amount" id="amount" required placeholder="Transaction amount">
            </div>
